 ...
 */
final class Version20230203093740 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cheval (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(40) NOT NULL, sire INT NOT NULL, sexe VARCHAR(1) NOT NULL, prix_de_depart NUMERIC(2, 2) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE lot (id INT AUTO_INCREMENT NOT NULL, mise_à_prix NUMERIC(10, 2) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
